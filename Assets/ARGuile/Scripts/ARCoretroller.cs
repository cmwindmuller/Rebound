...
namespace GoogleARCore
{
    ...
    /// </summary>
    public class ARCoretroller : MonoBehaviour
    {
        /// <summary>
        ...
        private static Color[] m_planeColors = new Color[] {
        ...
        {
            return m_planeColors[Random.Range(0,
